...
ㅁ. Shoes Shop의 정책과 위배 되어지는 행위를 반복적으로 자행하여 회원 자격 상실을 한 적이 있는 경우
...
(3) ‘Shoes Shop’의 이용자ID는 이용자 본인의 동의하에 ‘Shoew Shop’ 가 운영하는 자사 사이트의 회원ID와 연결될 수 있습니다.
...
(14) 회사는 회원이 Shoes Shop을 이용함으로써 회원 본인 또는 제3자에게 직/간접적으로 영향을 미치게 되는 모든 피해와 법적 문제에 대하여 책임을 지지 않습니다.
